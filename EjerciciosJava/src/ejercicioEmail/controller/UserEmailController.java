...
public class UserEmailController {
     ...
     */
    public RespuestasHTTP insertUserEmail(UserEmail u) {
        try {
            UserEmail u2 = service.insertUserEmail(u);
            if(service.getUserEmail(u.getEmail()) != null) {
    ...
    public RespuestasHTTP deleteUserEmail(String email) {
        try {
            ...
            boolean b = service.deleteUserEmail(email);
            return b ?
